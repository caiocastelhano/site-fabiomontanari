export const dictionary = {
  ...
  footer: {
    en: {
        line: '© {year} Fabio Montanari. All rights reserved. Developed by',
        aria: 'Caio Castelhano website (opens in new tab)',
    },
    pt: {
        line: '© {year} Fabio Montanari. Todos os direitos reservados. Desenvolvido por',
        aria: 'Website de Caio Castelhano (abre em nova aba)',
    },
  },
};
