  ...
  pt: {
    projects: {
      ...
      chessShop: {
        ...
        description: `No último dia de funcionamento de uma loja de xadrez, dois colegas de longa data enfrentam a obsolescência e um futuro incerto.Curta-metragem.`
      },
      bestFriends: {
        title: "BEST FRIENDS",
